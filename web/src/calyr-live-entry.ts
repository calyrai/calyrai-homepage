...
function applyMarkdownVisibility(frame: HTMLIFrameElement) {
  ...
  style.textContent = [
    ...
    ,`#explore_data{--calyr-accent:#ff38d1}#explore_surrogate{--calyr-accent:#ffd400}#explore_oracle{--calyr-accent:#00d4ff}#impressum_tile{--calyr-accent:#168cff}.page-main #movie .calyr-workflow-tile>.tile-icon,.page-main #movie .calyr-workflow-tile .calyr-case-kicker,.page-main #movie .calyr-workflow-tile>.tile-link-indicator{color:var(--calyr-accent)!important}.page-main #movie .calyr-workflow-tile{border-color:rgba(241,241,237,.7)!important;background:#050505!important}.page-main #movie .calyr-imprint-tile{background:#050505!important}.page-main #movie .calyr-imprint-tile .tile-title{position:static!important;top:auto!important;left:auto!important;margin:0 0 clamp(70px,10vw,150px)!important}`
  ].join("\n");
  ...
  if (main && !document.getElementById("impressum_tile")) {
    ...
    tile.className = "tile calyr-imprint-tile calyr-workflow-tile";
    const icon = document.createElement("div");
    icon.className = "tile-icon";
    const marker = document.createElement("span");
    marker.className = "calyr-case-number";
    ...
    details.replaceChildren(...imprintRows.map(([term, description]) => {
    ...
    content.append(kicker, heading, details);
