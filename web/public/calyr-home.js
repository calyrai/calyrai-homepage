(() => {
  ...
  style.textContent += `@media(max-width:600px){.calyr-burger{left:max(3rem,calc(env(safe-area-inset-left) + 3rem))}.calyr-brand-rail{left:max(6.15rem,calc(env(safe-area-inset-left) + 6.15rem))}}`;
