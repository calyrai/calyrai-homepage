...
<section class="hero" id="hero">
  <div class="hero-orbit-logo">
    <div
      ...
      tabindex="0"
      aria-label="Calyrai"
      style="--orbit-size: min(48vmin, 360px); --orbit-accent-rot: 140s;"
    >
      <svg class="orbit-logo__svg" viewBox="0 0 200 200" role="img" aria-label="Calyrai" focusable="false">
        <defs>
  ...
  <div class="hero-copy">
    ...
    <h1 class="hero-title">Cal&iacute;r.ai — AI-Dr&iacute;ven Structuralom&iacute;cs</h1>
