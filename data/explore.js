window.CALYR_EXPLORE = [
  {
    ...
    alwaysOpen: true,
    pages: [
      { id: 'overview', title: 'Overview', src: 'pages/explore_overview.html' }
    ]
  },
  {
    id: 'spr',
  ...
  },
  {
    ...
    pages: [
      {
        id: 'signal-governed-molecular-inference',
        title: 'Signal-governed molecular inference',
        src: 'pages/explore_signal_governed.html'
      },
      {
      ...
      {
        id: 'from-signal-to-decision',
        title: 'From signal to decision',
        src: 'pages/explore_from_signal_to_decision.html'
      },
      {
        id: 'decision-making-in-constrained-molecular-systems',
        title: 'Decision-making in constrained molecular systems',
        src: 'pages/explore_decision_making_constrained_systems.html'
      },
      {
